...
covars_outcome <- readRDS(paste0("data/covars_outcome_time_1_years_obs_", years, ".rds"))

# reading data, 445 observations non-missing
pol <- readRDS(paste0("data/exposures_7_classes_time_1_years_obs_", years, ".rds"))
...
saveRDS(shifted_mult_data, paste0("data/shifted_data_80_percent_time_1_years_obs_", years, ".rds"))
saveRDS(shifted_add_data, paste0("data/shifted_data_10_scaled_units_time_1_years_obs_", years, ".rds"))
saveRDS(original_data, paste0("data/original_data_time_1_years_obs_", years, ".rds"))
}
