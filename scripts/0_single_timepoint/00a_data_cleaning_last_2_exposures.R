...
for (years in c("1", "1_5", "2"))
{
  ...
  saveRDS(classes, paste0("data/exposures_7_classes_time_1_years_obs_", years, "_last_2_exposures.rds"))
  ...
  saveRDS(covars_outcome, paste0("data/covars_outcome_time_1_years_obs_", years, "_last_2_exposures.rds"))
}