...
for (i in 3:3)
{
  ...
  saveRDS(mult_all, here::here(paste0("results_072225/", "mhtn_mult_t_", i, "_shifting_first_5_20percent.rds")))
  
  set.seed(5)
  obs_all <- run_lmtp(shifted = NULL)
  saveRDS(obs_all, here::here(paste0("results_072225/", "mhtn_obs_t_", i, "_shifting_first_5_20percent.rds")))
