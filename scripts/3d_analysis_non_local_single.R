...
saveRDS(mult_all, here::here(paste0("results/", "non_local_mult.rds")))

set.seed(5)
obs_all <- run_lmtp(shifted = NULL)
saveRDS(obs_all, here::here(paste0("results/", "non_local_obs.rds")))

obs_all <- readRDS(here::here(paste0("results/", "non_local_obs.rds")))
mult_all <- readRDS(here::here(paste0("results/", "non_local_mult.rds")))
