    ...
    mutate(cham = cham - 1, # making into 0-1
           ...
           age_9y = case_when(is.na(age_9y) & is.na(age_10_5y) == FALSE ~ age_10_5y - 1.5, # approximation
            ...
            age_mc1 = case_when(is.na(bodyage_mc1) & is.na(age_18y) == FALSE ~ age_18y + 2, # approximation
                                ...
                                TRUE ~ bodyage_mc1),
           # shifting variables back by 1 to align temporally
           age_mc1 = age_18y,
           age_18y = age_16y,
           age_16y = age_12y,
           age_12y = age_10_5y,
           ...
           # shifting variables back by 1 to align temporally
           marstat_mc1 = marstat_18y,
           marstat_18y = marstat_16y,
           marstat_16y = marstat_12y,
           marstat_12y = marstat_10_5y,
           marstat_10_5y = marstat_9y,
           marstat_mc1_missing = marstat_18y_missing,
           marstat_18y_missing = marstat_16y_missing,
           marstat_16y_missing = marstat_12y_missing,
           marstat_12y_missing = marstat_10_5y_missing,
           marstat_10_5y_missing = marstat_9y_missing,
           ...
           # shifting variables back by 1 to align temporally
           marcat_mc1 = marcat_18y,
           marcat_18y = marcat_16y,
           marcat_16y = marcat_12y,
           marcat_12y = marcat_10_5y,
           marcat_10_5y = marcat_9y,
           marcat_mc1_missing = marcat_18y_missing,
           marcat_18y_missing = marcat_16y_missing,
           marcat_16y_missing = marcat_12y_missing,
           marcat_12y_missing = marcat_10_5y_missing,
           marcat_10_5y_missing = marcat_9y_missing,
           ...
           # shifting variables back by 1 to align temporally
           ipovcat_mc1 = ipovcat_18y,
           ipovcat_18y = ipovcat_16y,
           ipovcat_16y = ipovcat_12y,
           ipovcat_12y = ipovcat_10_5y,
           ipovcat_10_5y = ipovcat_9y,
           ipovcat_mc1_missing = ipovcat_18y_missing,
           ipovcat_18y_missing = ipovcat_16y_missing,
           ipovcat_16y_missing = ipovcat_12y_missing,
           ipovcat_12y_missing = ipovcat_10_5y_missing,
           ipovcat_10_5y_missing = ipovcat_9y_missing,
           ...
           # shifting variables back by 1 to align temporally
           hhagwork_mc1 = hhagwork_18y,
           hhagwork_18y = hhagwork_16y,
           hhagwork_16y = hhagwork_12y,
           hhagwork_12y = hhagwork_10_5y,
           hhagwork_10_5y = hhagwork_9y,
           hhagwork_mc1_missing = hhagwork_18y_missing,
           hhagwork_18y_missing = hhagwork_16y_missing,
           hhagwork_16y_missing = hhagwork_12y_missing,
           hhagwork_12y_missing = hhagwork_10_5y_missing,
           hhagwork_10_5y_missing = hhagwork_9y_missing,
           ...
           # shifting variables back by 1 to align temporally
           work_cat_mc1 = work_cat_18y,
           work_cat_18y = work_cat_16y,
           work_cat_16y = work_cat_12y,
           work_cat_12y = work_cat_10_5y,
           work_cat_10_5y = work_cat_9y,
           work_cat_mc1_missing = work_cat_18y_missing,
           work_cat_18y_missing = work_cat_16y_missing,
           work_cat_16y_missing = work_cat_12y_missing,
           work_cat_12y_missing = work_cat_10_5y_missing,
           work_cat_10_5y_missing = work_cat_9y_missing
    ) |>
