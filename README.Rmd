...
- File `00_data_cleaning.R` contains basic data cleaning on the original data (n = 621), such as:
  ...
  - Removing individuals who experienced outcome or were reported to have high blood pressure prior to time period 1 (n = 142 removed)
...
- File `1_convex_hull.R` contains code to normalize the treatment variables and apply the convex hull at each time period independently
  ...
  - When applying the shift, 64.6%, 63.5%, 52.6%, 49.3%, and 55.7% of individuals stay within the bounds of the convex hull for the 20% reductions of the two herbicides at time points 1, 2, 3, 4, and 5, respectively.
    - NOTE: the percent of individuals staying within the bounds of the convex hull changes depending on the rounding done (more rounding means more people stay in the bounds of the convex hull) -- we could consider rounding to 2 digits (85.4%, 83.7%, 80.1%, 73.7%, 78.1%.
